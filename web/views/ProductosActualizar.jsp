                        ...
                        <div class="col-lg-12">
                            <form method="post" action="Productos">
                                <%
                                    ...
                                    menu cli = (menu)dao.getById(id);
                                %>
                                <div class="card-header mb-3">
                                    <h5 class="modal-title">ACTUALIZAR PLATO DEL MENU</h5>                                   
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-xl-6 mb-3">
                                            <div class="example">
                                                ...
                                                <input class="form-control" type="text" required="true" name="proNombre" value="<%= cli.getMenNombre()%>">
                                                <input class="form-control" type="hidden" required="true" name="idProducto" value="<%= cli.getIdMenu()%>">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 mb-3">
                                            <div class="example">
                                                <p class="mb-1 text-primary">Codigo:</p>
                                                <input type="text" class="form-control" required="true" name="proCodigo" value="<%= cli.getMenCodigo()%>">
                                            </div>
                                        </div>                                            
                                    </div>                                                                     
                                    <div class="row">                            
                                        <div class="col-xl-6 mb-3">
                                            <div class="example">
                                                ...
                                                <input type="number"  class="form-control" maxlength="10"  required="true" name="proStock" value="<%= cli.getMenStock()%>">
                                            </div>
                                        </div>      
                                        <div class="col-xl-6 mb-3">
                                            <div class="example">
                                                <p class="mb-1 text-primary">Precio:</p>
                                                <input class="form-control" type="decimal" required="true" name="proPrecio" value="<%= cli.getMenPrecio()%>">
                                            </div>
                                        </div>
                                    </div>                                                                                                                                                         
                                </div>
