                                            ...
                                            <tbody>
                                                ...
                                                <tr>                                                    
                                                    <td class="d-flex justify-items-center gap-2"> 
                                                        <div>
                                                                <a href="Usuarios?accion=editar&idUsuario=<%= ch.getIdUsuario()%>" class="btn btn-primary"><i class="fas fa-pencil-alt text-primary"></i>&nbsp; Actualizar</a>
                                                            </div>
                                                            <div class="dropdown-divider"></div>
                                                            <div>
                                                                <a href="Usuarios?accion=eliminar&idUsuario=<%= ch.getIdUsuario()%>" class="btn btn-danger"><i class="fas fa-arrow-circle-down text-secondary"></i>&nbsp; Eliminar</a>
                                                            </div>
                                                    </td>	                                               
